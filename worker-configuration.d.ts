/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 44fd1568f33a15c83aa17d1ecba8cdaa)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		R2_PUBLIC_HOST: "https://yfyz-r2.fologde.com";
		LOCAL_PUBLIC_HOST: "http://localhost:8787";
		WX_APPID: string;
		WX_SECRET: string;
		JWT_SECRET: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_HOST" | "LOCAL_PUBLIC_HOST" | "WX_APPID" | "WX_SECRET" | "JWT_SECRET">> {}
}
